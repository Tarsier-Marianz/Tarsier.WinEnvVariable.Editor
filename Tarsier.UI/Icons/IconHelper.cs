...
namespace Tarsier.UI.Icons {
	...
	/// </summary>
	/// <example>
	/// <code>IconReader.GetFileIcon("c:\\sample.xls");</code>
	/// </example>
	public class IconReader {
        ...
        private static Icon ResolvedIcon() {
            Bitmap myBitmap = new Bitmap(Resources.error16);
    ...
    public class Shell32 {
        ...
        public static string GetFileType(FileInfo fileInfo) {
            SHFILEINFO info = GetFileInfo(fileInfo.FullName);
