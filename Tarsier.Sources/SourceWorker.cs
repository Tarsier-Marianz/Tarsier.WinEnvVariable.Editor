...
namespace Tarsier.Sources {
    public class SourceWorker : Component {
        // Private statics
        ...
        public void CancelAsync() {
            if(!WorkerSupportsCancellation) {
                throw new InvalidOperationException("This Worker states doesn't support cancellation");
            }

            cancellationPending = true;
        }

        [Category("Asynchronous"),Description("BackgroundWorker_DoWork")
        ]
        ...
        [Category("Asynchronous"),  Description("SR.BackgroundWorker_ProgressChanged")]
        ...
        [
          Category("Asynchronous"),Description("SR.BackgroundWorker_RunWorkerCompleted")
        ]
        ...
        [Category("Asynchronous"),
          Description("SR.BackgroundWorker_WorkerReportsProgress"),
          DefaultValue(false)
        ]
        ...
        [
          Category("Asynchronous"),
          Description("SR.BackgroundWorker_WorkerSupportsCancellation"),
          DefaultValue(false)
        ]
